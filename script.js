...
<body>
    ...
    <script>
        ...
        function showEndGameScreen() {
            ...
            document.getElementById('percentageFeedback').innerText = `Percentage of correct answers: ${document.getElementById('percentage').innerText}`;
            if (parseFloat(document.getElementById('percentage').innerText) >= 80) {
                document.getElementById('percentageFeedback').innerHTML += "<br>Excellent!";
            } else {
                document.getElementById('percentageFeedback').innerHTML += "<br>Keep practicing!";
            }
        }
        ...
        // Event listener for exit buttons
